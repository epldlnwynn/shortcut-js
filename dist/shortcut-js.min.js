"use strict";exports.__esModule=true;;var MODULES=["ctrl","shift","alt","meta"];var KeyboardShortcut=(function(){function KeyboardShortcut(){this._D=document.body;this._listeners={};this._keydownHandler=this._keydownHandler.bind(this);}
...
var element=this._element(el),hotKeys={code:''};var hotKeysHandler=function(e){var _a;var type=e.type,ev=e;if("keydown"===type){isDone=false,hotKeys.alt=e.altKey,hotKeys.shift=e.shiftKey,hotKeys.ctrl=e.ctrlKey,hotKeys.meta=e.metaKey,hotKeys.keyCode=e.keyCode,hotKeys.code=e.code.substring(e.code.startsWith("Key")?3:0);MODULES.map(function(k){if(ev[k+'Key']&&!(k in sequence))
...
el&&this._removeEvent(el,"keydown",this._keydownHandler);return this;};KeyboardShortcut.prototype._addEvent=function(el,type,l,once){el===null||el===void 0?void 0:el.addEventListener(type,l,{capture:false,once:once});return this;};KeyboardShortcut.prototype._removeEvent=function(el,type,l){el===null||el===void 0?void 0:el.removeEventListener(type,l,false);el===null||el===void 0?void 0:el.removeAttribute("aria-keyshortcuts");return this;};KeyboardShortcut.prototype._bind=function(el,keys,l,propagate,once){var ks=this._compose(keys),element=this._element(el);this._listeners[ks]=l;this._listeners[ks].propagate=propagate;once==false&&element.setAttribute("aria-keyshortcuts",ks);this._addEvent(element,"keydown",this._keydownHandler,once);return this;};KeyboardShortcut.prototype._compose=function(keys){var k;if(typeof(keys)==="string"){var ar=keys.split('+');k={code:ar[ar.length-1]};MODULES.map(function(s){k[s]=keys.indexOf(s)!=-1;});}
else{k=keys;}
